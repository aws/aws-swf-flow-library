...
/**
 * Monitors the state of ExecutorServices.
 */
public interface ExecutorServiceMonitor {
    ...
    /**
     * Notifies the consumer of newly monitored ExecutorService.
     */
    void registerCallback(BiConsumer<ExecutorService, String> eventConsumer);
}
